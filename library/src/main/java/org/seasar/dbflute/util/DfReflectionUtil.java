...
public class DfReflectionUtil {
     ...
     * <pre>
     * o target class's methods = allColumns
     ...
     * <pre>
     * o target class's methods = allColumns
     * o superclass's methods   = allColumns (also contains private)
     * </pre>
     ...
     * @throws org.seasar.dbflute.util.DfReflectionUtil.ReflectionFailureException When invocation failure and illegal access
     */
