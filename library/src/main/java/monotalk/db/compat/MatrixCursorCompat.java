 ...
 * needed.
 */
public class MatrixCursorCompat extends MatrixCursor {
    ...
    private void addRow(ArrayList<?> columnValues, int start) {
        ...
        if (size != columnCount) {
            throw new IllegalArgumentException("columnNames.length = " + columnCount + ", columnValues.size() = "
                    + size);
        }
     ...
     */
    public class RowBuilderCompat {

        private final int endIndex;
        private int index;

        RowBuilderCompat(int index, int endIndex) {
            this.index = index;
         ...
         */
        public RowBuilderCompat add(Object columnValue) {
            if (index == endIndex) {
