...
public enum ConflictClause {
     ...
     * violation on the 100th row that it attempts to newUpdate, then the first 99 row changes are preserved but changes
     ...
     * deleteByWhereArrayStringArgs triggers fire if and only if recursive triggers are enabled.
     * </p>
     * <p>
     * The newUpdate hook is not invoked for rows that are deleted by the REPLACE conflict resolution strategy. Nor does
