...
public @interface ForeignKey {
    /**
     * <p>
     * Perform an action on referenced rows on newUpdate and delete.
     * </p>
    ...
    public enum ReferentialAction {
        ...
        /**
         * A "CASCADE" action propagates the delete or newUpdate operation on the parent key to each dependent child key.
    ...
    /**
     * Referential action to perform upon newUpdate of this key.
     *
     * @return The referential action.
     */
