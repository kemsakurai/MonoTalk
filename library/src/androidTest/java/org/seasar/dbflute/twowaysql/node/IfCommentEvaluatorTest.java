...
public class IfCommentEvaluatorTest {
    ...
    public void test_evaluate_list_notNumber() {
        ...
        // ## Act ##
        createEvaluator(pmb, "pmb.listPmb.get(0).existsLogin").evaluate(); // no
        // exception
        try {
    ...
    // @Test public void test_evaluate_cdef() {
    // // ## Arrange & Act && Assert ##
    ...
    protected IfCommentEvaluator createEvaluator(final Object pmb, String expression) {
        ...
        }, expression, "newSelect foo from bar", null);
    }
