...
public class ForNodeTest {
    ...
    // =====
    @Test
    public void accept_basic() throws Exception {
        // ## Arrange ##
        ...
        sb.append("newSelect * from MEMBER").append(log.ln());
        sb.append(" where").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*/").append(log.ln());
        sb.append("   and MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*END*/");
        ...
        log.i(log.ln() + actual);
        assertTrue(actual.contains("newSelect * from MEMBER"));
    ...
    @Test
    public void accept_FirstAnd() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likePrefix());
        ...
        sb.append(" where").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*/").append(log.ln());
        sb.append("   /*FIRST*/and /*END*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
        Node rootNode = analyzer.analyze();
        CommandContext ctx = createCtx(pmb);
    ...
    @Test
    public void accept_NextAnd() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        ...
        sb.append(" where").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*/").append(log.ln());
        sb.append("   /*NEXT 'and '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
        Node rootNode = analyzer.analyze();
        CommandContext ctx = createCtx(pmb);
    ...
    @Test
    public void accept_LastAnd() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likePrefix());
        ...
        sb.append(" where").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*/").append(log.ln());
        sb.append("   /*LAST*/and /*END*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
        Node rootNode = analyzer.analyze();
        CommandContext ctx = createCtx(pmb);
    ...
    @Test
    public void accept_BEGIN_connectorAdjustment_go() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likePrefix());
        StringBuilder sb = new StringBuilder();
        sb.append("newSelect * from MEMBER").append(log.ln());
        sb.append(" /*BEGIN*/where").append(log.ln());
        sb.append("   /*IF pmb.memberId != null*/").append(log.ln());
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*/").append(log.ln());
        sb.append("   and MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append(" /*END*/");
    ...
    @Test
    public void accept_BEGIN_connectorAdjustment_not() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(3);
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
    ...
    @Test
    public void accept_currentParameter_in_IF() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        ...
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*IF #current == 'foo'*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/");
        sb.append("     /*IF #current == 'bar'*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_ACCOUNT like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/");
        sb.append("     /*IF #current.length() == 6*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_BAZ like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/");
        sb.append("     /*IF #current.length() == 99*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_BAZ like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/");
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
        Node rootNode = analyzer.analyze();
        CommandContext ctx = createCtx(pmb);
    ...
    @Test
    public void accept_loopVariable_in_IF() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
        ...
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*//*IF true*//*FIRST*/and (/*END*//*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
    ...
    @Test
    public void accept_nested_BEGIN_in_loop() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likePrefix());
        ...
        sb.append("   /*FOR pmb.memberNameList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*BEGIN*/where").append(log.ln());
        sb.append("     /*IF false*/").append(log.ln());
        sb.append("     MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/").append(log.ln());
        sb.append("     /*IF true*/").append(log.ln());
        sb.append("     or MEMBER_ACCOUNT like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/").append(log.ln());
        sb.append("     /*IF true*/").append(log.ln());
        sb.append("     or MEMBER_ACCOUNT like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*END*/").append(log.ln());
    ...
    @Test
    public void accept_allStars_all_true() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(4);
    ...
    @Test
    public void accept_allStars_connectorAdjustment() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
    ...
    @Test
    public void accept_allStars_connectorAdjustment_no() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likePrefix());
        StringBuilder sb = new StringBuilder();
        sb.append("newSelect * from MEMBER");
    ...
    @Test
    public void accept_allStars_connectorAdjustment_LAST() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
        ...
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*//*LAST '@'*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
    ...
    @Test
    public void accept_emptyList() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
    ...
    @Test
    public void accept_nullList() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
    ...
    @Test
    public void accept_nullElement_in_IF() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
    ...
    @Test
    public void accept_allStars_embedded_either_true() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likePrefix());
    ...
    @Test
    public void accept_allStars_several_basic() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
        ...
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append("   /*FOR pmb.memberAccountList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_ACCOUNT like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
    ...
    // ======
    @Test
    public void accept_nested_basic() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
    ...
    @Test
    public void accept_nested_current_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        ...
        }
        {
            ...
            // element.setMemberNameListInternalLikeSearchOption(new
            // LikeSearchOption().likePrefix());
            nestPmbList.add(element);
        }
        ...
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_ID = /*#current.memberId*/99").append(log.ln());
        sb.append("     /*FOR #current.memberNameList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("       /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("     /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
    ...
    @Test
    public void accept_nested_current_in_FOR_nullElement() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        List<MockPmb> nestPmbList = DfCollectionUtil.newArrayList();
        {
    ...
    @Test
    public void accept_nested_parent_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        ...
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_STATUS_CODE = /*#current.memberStatusCode*/'test'").append(log.ln());
        sb.append("     /*FOR #current.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("       /*NEXT 'or '*/MEMBER_NAME like /*#current.parentPmb.memberName*/'foo%'").append(log.ln());
        sb.append("     /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
        ...
        assertTrue(actual.contains(" )"));
        assertTrue(Srl.count(actual, " )") == 3);
        assertEquals("FML%", ctx.getBindVariables()[0]); // because of not using
        // notLike option
        assertEquals("foo%", ctx.getBindVariables()[1]);
        assertEquals("foo%", ctx.getBindVariables()[2]);
        assertEquals("WDL%", ctx.getBindVariables()[3]); // because of not using
        // notLike option
    ...
    @Test
    public void accept_nested_inLoopOption_notLike_bind_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberName("parent"); // unused
        List<MockPmb> nestPmbList = DfCollectionUtil.newArrayList();
        ...
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_STATUS_CODE = /*#current.memberStatusCode:notLike*/'test'").append(
                log.ln());
        sb.append("     /*FOR #current.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("       /*NEXT 'or '*/MEMBER_NAME like /*#current.parentPmb.memberName*/'foo%'").append(log.ln());
        sb.append("     /*LAST*/)/*END*//*END*/").append(log.ln());
    ...
    @Test
    public void accept_nested_inLoopOption_likeContain_bind_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberName("parent"); // unused
        List<MockPmb> nestPmbList = DfCollectionUtil.newArrayList();
        ...
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_STATUS_CODE = /*#current.memberStatusCode:likeSuffix*/'test'").append(
                log.ln());
        sb.append("     /*FOR #current.nestPmbList*//*FIRST*/and (/*END*/").append(log.ln());
    ...
    @Test
    public void accept_nested_notLike_embedded_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberName("parent"); // unused
        List<MockPmb> nestPmbList = DfCollectionUtil.newArrayList();
    ...
    @Test
    public void accept_nested_bind_overrideOption_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberName("parent"); // unused
        List<MockPmb> nestPmbList = DfCollectionUtil.newArrayList();
    ...
    @Test
    public void accept_nested_bind_notInheritOption_in_FOR() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(3);
        ...
        sb.append("   /*FOR pmb.memberNameList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("     or MEMBER_ACCOUNT like /*pmb.memberName*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
        Node rootNode = analyzer.analyze();
    ...
    // =========
    @Test
    public void accept_endNotFound() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
        ...
        sb.append("   /*FOR pmb.memberNameList*//*FIRST*/and (/*END*/").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*/").append(log.ln());
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
    ...
    @Test
    public void accept_FIRST_endNotFound() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        pmb.setMemberNameListInternalLikeSearchOption(new LikeSearchOption().likeContain());
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("newSelect * from MEMBER").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*//*FIRST*/and (").append(log.ln());
        sb.append("     /*NEXT 'or '*/MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*LAST*/)/*END*//*END*/").append(log.ln());
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
    ...
    @Test
    public void accept_currentParameter_in_Bind_null_allowed() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(3);
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", null, "baz"));
    ...
    @Test
    public void accept_currentParameter_in_Bind_null_notAllowed() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(3);
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", null, "baz"));
    ...
    @Test
    public void accept_currentParameter_outOfForComment() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(3);
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("newSelect * from MEMBER").append(log.ln());
        sb.append(" /*#current*/where").append(log.ln());
        sb.append("   /*IF pmb.memberId != null*/").append(log.ln());
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FOR pmb.memberNameList*/").append(log.ln());
    ...
    @Test
    public void accept_FOR_spellMiss() throws Exception {
        // ## Arrange ##
        MockPmb pmb = new MockPmb();
        pmb.setMemberId(3);
        pmb.setMemberNameList(DfCollectionUtil.newArrayList("foo", "bar", "baz"));
        ...
        sb.append("   MEMBER_ID = /*pmb.memberId*/").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append("   /*FAR pmb.memberNameList*/").append(log.ln());
        sb.append("   and MEMBER_NAME like /*#current*/'foo%'").append(log.ln());
        sb.append("   /*END*/").append(log.ln());
        sb.append(" /*END*/");
        SqlAnalyzer analyzer = new SqlAnalyzer(sb.toString(), false);
